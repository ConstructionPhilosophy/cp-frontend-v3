...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-6">
            ...
            <div className="text-center">
              <span className="text-sm text-cmo-text-secondary">New on CMOlist? </span>
              <Link href="/signup">
